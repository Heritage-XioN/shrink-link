		...
		<div className={cn('flex flex-col gap-6', className)} {...props}>
			<Card>
				<CardHeader className='text-center'>
					<CardTitle className='text-xl text-[#A667E4FF] font-black'>
						Create your account
					</CardTitle>
					<CardDescription className='text-[#A667E4FF] font-bold'>
						Click on Apple or Google option to create your account
					</CardDescription>
				</CardHeader>
				<CardContent>
					<form
						...
						<FieldGroup>
							...
							<Field>
								...
								<FieldDescription className='text-center'>
									...
									<Link href='/auth/login' className='text-[#A667E4FF]'>
										Login
									</Link>
								</FieldDescription>
							</Field>
